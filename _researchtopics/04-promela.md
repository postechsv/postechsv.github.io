...
PROMELA is the input modeling language for the SPIN model checker and is widely used to analyze distributed and concurrent systems. PROMELA’s official documentation ([https://spinroot.com](https://spinroot.com)) defines its syntax and informal semantics, but it does not provide a machine-readable, formal specification.
...
1. Byoungho Son and Kyungmin Bae. <em>A Formal Executable Semantics of PROMELA.</em> VMCAI 2026. [[paper](https://link.springer.com/chapter/10.1007/978-3-032-15700-3_16), [artifact](https://doi.org/10.5281/zenodo.17183744)]
...
---
Last modified: 2025/11/16 (Byoungho Son)
